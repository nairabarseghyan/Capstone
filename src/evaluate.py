...
def evaluate_lag_llama_model(tss_train, forecasts_train, tss_val, forecasts_val,model_name, prediction_type = "zs"):
    
    evaluator = Evaluator()
    if prediction_type == "zs":
        ...
        mape_train = agg_metrics_train["MAPE"]
        mape_val = agg_metrics_val["MAPE"]
        
        rmse_train = agg_metrics_train["RMSE"]
